...
/* search for ngspice libraries 1 - 3, create them by copying, if not already existing */
    ...
    ret = ((int * (*)(char*)) ngSpice_Command_handle1)("source ../../examples/ninv_oc1.cir");
    ret = ((int * (*)(char*)) ngSpice_Command_handle2)("source ../../examples/ninv_oc2.cir");
    ret = ((int * (*)(char*)) ngSpice_Command_handle3)("source ../../examples/ninv_oc3.cir");
